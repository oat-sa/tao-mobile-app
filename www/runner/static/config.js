(function(){
    ...
    require.config({
        ...
        config: {
            context: {
                'dataUrl' : domain + baseDir + 'data/' + testId + '/',
            ...
            'ui/themes': {
                items: {
                    'base': '../../../../src/taoQtiItem/views/css/qti-runner.css',
                    'available': [{
                        'id': 'tao',
                        'name': 'TAO',
                        'path': '../../../../src/taoQtiItem/views/css/themes/default.css'
                    }],
                    'default': 'tao'
                }
            },
        ...
        paths: {
            ...
            'IMSGlobal/jquery_2_1_1': '../../../taoQtiItem/views/js/legacyPortableSharedLib/jquery_2_1_1',
            'OAT/lodash': '../../../taoQtiItem/views/js/legacyPortableSharedLib/lodash',
            'OAT/async': '../../../taoQtiItem/views/js/legacyPortableSharedLib/async',
            'OAT/raphael': '../../../taoQtiItem/views/js/legacyPortableSharedLib/raphael',
            'OAT/scale.raphael': '../../../taoQtiItem/views/js/legacyPortableSharedLib/OAT/scale.raphael',
            'OAT/jquery.qtip': '../../../taoQtiItem/views/js/legacyPortableSharedLib/jquery.qtip',
            'OAT/util/xml': '../../../taoQtiItem/views/js/legacyPortableSharedLib/OAT/util/xml',
            'OAT/util/math': '../../../taoQtiItem/views/js/legacyPortableSharedLib/OAT/util/math',
            'OAT/util/html': '../../../taoQtiItem/views/js/legacyPortableSharedLib/OAT/util/html',
            'OAT/util/EventMgr': '../../../taoQtiItem/views/js/legacyPortableSharedLib/OAT/util/EventMgr',
            'OAT/util/event': '../../../taoQtiItem/views/js/legacyPortableSharedLib/OAT/util/event',
            'OAT/util/asset': '../../../taoQtiItem/views/js/legacyPortableSharedLib/OAT/util/asset',
            'OAT/util/tpl': '../../../taoQtiItem/views/js/legacyPortableSharedLib/OAT/util/tpl',
            'OAT/sts/common': '../../../taoQtiItem/views/js/legacyPortableSharedLib/OAT/sts/common',
            'OAT/interact': '../../../taoQtiItem/views/js/legacyPortableSharedLib/interact',
            'OAT/interact-rotate': '../../../taoQtiItem/views/js/legacyPortableSharedLib/OAT/interact-rotate',
            'OAT/sts/transform-helper': '../../../taoQtiItem/views/js/legacyPortableSharedLib/OAT/sts/transform-helper',
            'OAT/handlebars': '../../../taoQtiItem/views/js/legacyPortableSharedLib/handlebars',
            'OAT/sts/stsEventManager': '../../../taoQtiItem/views/js/legacyPortableSharedLib/OAT/sts/stsEventManager',
            'OAT/waitForMedia': '../../../taoQtiItem/views/js/legacyPortableSharedLib/OAT/waitForMedia',
            'OAT/customEvent': '../../../taoQtiItem/views/js/legacyPortableSharedLib/OAT/customEvent',
            'OAT/mediaPlayer': '../../../taoQtiItem/views/js/legacyPortableSharedLib/OAT/mediaPlayer',
    ...
    var testConfig = {
        ...
        testCompilation: testId,
        serviceCallId: testId,
